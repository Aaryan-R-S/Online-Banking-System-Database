...
CREATE TABLE `term_life_insurance` (
  ...
  KEY `term_life_insurance_ibfk_2` (`insured_person`),
  CONSTRAINT `term_life_insurance_ibfk_1` FOREIGN KEY (`policy_id`) REFERENCES `insurance` (`policy_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `term_life_insurance_ibfk_2` FOREIGN KEY (`insured_person`) REFERENCES `personal_customer` (`cin`) ON DELETE CASCADE ON UPDATE CASCADE
