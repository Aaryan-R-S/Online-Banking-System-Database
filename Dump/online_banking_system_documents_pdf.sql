...
CREATE TABLE `documents_pdf` (
  ...
  KEY `documents_pdf_ibfk_1` (`loan_id`),
  CONSTRAINT `documents_pdf_ibfk_1` FOREIGN KEY (`loan_id`) REFERENCES `non_collateral_loan` (`loan_id`) ON DELETE CASCADE ON UPDATE CASCADE
