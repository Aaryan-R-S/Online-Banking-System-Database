...
CREATE TABLE `advertisement` (
  ...
  KEY `advertisement_ibfk_1` (`channel_id`),
  KEY `advertisement_ibfk_2` (`authorized_by`),
  CONSTRAINT `advertisement_ibfk_1` FOREIGN KEY (`channel_id`) REFERENCES `ad_channel` (`channel_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `advertisement_ibfk_2` FOREIGN KEY (`authorized_by`) REFERENCES `employee` (`employee_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2022-04-10 21:10:02
