...
class root_user:
    ...
    def print_query_menu(self,tname,req_op):
        ...
        all_ops = ["Create", "Read", "Update", "Delete", "Read all", "Truncate all"]
    ...
    def execute_query(self,myt,mytname,req_ops,inp):
        ...
        if ind == 0:
            ...
            print("Reading all table entries ")
            self.gt.readAll(mytname)
        elif ind == 5:
            print("Truncating all table entries ")
            x = 0
...
# Department add delete ka dekhlo rkhna h ya nhi and let me know
# Departments me id ke order me print nhi ho to better h ?

# Customers ke phone number number incomplete h data me :( My bad