...
class PersonalCustomer:
    def __init__(self,gt,myTables,pc_id):
        self.gt = gt
        ...
        self.policy_ids = []
        self.upi_ids = []
        temp = self.gt.read_custom(self.myTables[11][1],self.myTables[11][0],"cin",self.pc_id)
        if temp!=[]:
            self.bank_accounts.append(temp[0][0])
        temp = self.gt.read_custom(self.myTables[13][1],self.myTables[13][0],"parent_cin",self.pc_id)
        if temp!=[]:
            self.bank_accounts.append(temp[0][0])
        temp = self.gt.read_custom(self.myTables[14][1],self.myTables[14][0],"cin",self.pc_id)
        if temp!=[]:
            self.bank_accounts.append(temp[0][0])
        temp = self.gt.read_custom(self.myTables[21][1],self.myTables[21][0],"loan_given_to",self.pc_id)
        if temp!=[]:
            for i in range(len(temp)):
                self.loan_ids.append(temp[i][0])
        temp = self.gt.read_custom(self.myTables[26][1],self.myTables[26][0],"nominee_id",self.pc_id)
        if temp!=[]:
            for i in range(len(temp)):
    ...
    def execute_query(self,myt,mytname,req_ops,inp,key=None,pc_id=None):
        cnt = 1
        ind = -1 
        ...
        if ind == 0:
            if pc_id != None:
                self.gt.create_custom(myt,mytname,key,pc_id)
            else:
                print("[Create a new entry]")
                self.gt.create(myt,mytname)
        elif ind == 1:
            if pc_id != None:
                return self.gt.read_custom(myt,mytname,key,pc_id)
            else:
                print("[Read some entries]")
                return self.gt.read(myt,mytname)
        elif ind == 2:
            if pc_id != None:
                self.gt.update_custom(myt,mytname,key,pc_id)
            else:
                print("[Update some entries]")
                self.gt.update(myt,mytname)
        elif ind == 3:
            if pc_id != None:
                self.gt.delete_custom(myt,mytname,key,pc_id)
            else:
...
# to set
    ...
    def savings_account_op(self):
        ...
        try:
            # self.print_query_menu(mytname,req_ops)
            # inp = input("Enter your choice : ")
            acc_num = self.execute_query(myt,mytname,req_ops,2,"cin",self.pc_id)
            # print(acc_num)
            if acc_num==[]:
    ...
    def minor_account_op(self):
        ...
        try:
            # self.print_query_menu(mytname,req_ops)
            # inp = input("Enter your choice : ")
            acc_num = self.execute_query(myt,mytname,req_ops,2,"parent_cin",self.pc_id)
            # print(acc_num)
            if acc_num==[]:
                print(self.statements["nothing_found"])
            else:
    ...
    def prepaid_card_op(self):
        ...
        try:
            ...
            # inp = input(myt["linked_account"])
            # self.execute_query(myt,mytname,req_ops,inp,"cin",self.pc_id)
            card_num = self.execute_query(myt,mytname,req_ops,2,"cin",self.pc_id)
            # print(acc_num)
            if card_num==[]:
                print(self.statements["nothing_found"])
            else:
    ...
    def loan_op(self):
        ...
        try:
            self.print_query_menu(mytname,req_ops)
            inp = input("Enter your choice : ")
            return self.execute_query(myt,mytname,req_ops,inp,"loan_given_to",self.pc_id)
    ...
    def insurance_op(self):
        ...
        try:
            self.print_query_menu(mytname,req_ops)
            inp = input("Enter your choice : ")
            return self.execute_query(myt,mytname,req_ops,inp,"nominee_id",self.pc_id)
    ...
    def term_life_insurance_op(self):
        ...
        try:
            self.print_query_menu(mytname,req_ops)
            inp = input("Enter your choice : ")
            return self.execute_query(myt,mytname,req_ops,inp,"insured_person",self.pc_id)
    ...
    def user_credential_op(self):
        ...
        try:
            self.print_query_menu(mytname,req_ops)
            inp = input("Enter your choice : ")
            return self.execute_query(myt,mytname,req_ops,inp,"user_id",self.pc_id)
