...
CREATE TABLE `loan_protection_insurance` (
  ...
  KEY `loan_id` (`loan_id`),
  CONSTRAINT `loan_protection_insurance_ibfk_1` FOREIGN KEY (`policy_id`) REFERENCES `insurance` (`policy_id`),
  CONSTRAINT `loan_protection_insurance_ibfk_2` FOREIGN KEY (`loan_id`) REFERENCES `loan` (`loan_id`)
