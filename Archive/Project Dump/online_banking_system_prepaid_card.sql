...
CREATE TABLE `prepaid_card` (
  ...
  KEY `cin` (`cin`),
  CONSTRAINT `prepaid_card_ibfk_1` FOREIGN KEY (`card_number`) REFERENCES `card` (`card_number`),
  CONSTRAINT `prepaid_card_ibfk_2` FOREIGN KEY (`cin`) REFERENCES `personal_customer` (`cin`)
