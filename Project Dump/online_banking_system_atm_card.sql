...
CREATE TABLE `atm_card` (
  ...
  CONSTRAINT `atm_card_ibfk_1` FOREIGN KEY (`card_number`) REFERENCES `card` (`card_number`),
  CONSTRAINT `atm_card_ibfk_2` FOREIGN KEY (`linked_account`) REFERENCES `bank_account` (`account_number`)
