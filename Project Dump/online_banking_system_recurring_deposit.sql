...
CREATE TABLE `recurring_deposit` (
  ...
  KEY `cin` (`cin`),
  CONSTRAINT `recurring_deposit_ibfk_1` FOREIGN KEY (`account_number`) REFERENCES `bank_account` (`account_number`),
  CONSTRAINT `recurring_deposit_ibfk_2` FOREIGN KEY (`cin`) REFERENCES `customer` (`cin`)
