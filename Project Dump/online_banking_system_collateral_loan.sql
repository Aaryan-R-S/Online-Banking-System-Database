...
CREATE TABLE `collateral_loan` (
  ...
  CONSTRAINT `collateral_loan_ibfk_1` FOREIGN KEY (`loan_id`) REFERENCES `loan` (`loan_id`),
  CONSTRAINT `collateral_loan_ibfk_2` FOREIGN KEY (`collateral_id`) REFERENCES `collateral` (`collateral_id`)
...
-- Dump completed on 2022-03-02 16:05:08
